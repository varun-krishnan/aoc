...
def check_overlap(sec1, sec2):
    is_overlap = int(sec2[0]) >= int(sec1[0]) and int(sec2[0]) <= int(sec1[1]) or \
                 int(sec2[1]) >= int(sec1[0]) and int(sec2[1]) <= int(sec1[1]) or \
                 int(sec1[0]) >= int(sec2[0]) and int(sec1[0]) <= int(sec2[1]) or \
                 int(sec1[1]) >= int(sec2[0]) and int(sec1[1]) <= int(sec2[1])
